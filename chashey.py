...
# function that does the task:
    ...
    12: [[1, 0, 28, 5, 15, 318], [13, 9, 0, 0, 0], [23, 56, 31, 0, 51, 389]],
    13: [[2, 54, 30, 3, 40, 683], [13, 13, 20, 0, 0], [24, 0, 49, 2, 26, 24]],
    14: [[4, 48, 49, 5, 47, 240], [13, 17, 40, 0, 0], [25, 4, 50, 0, 19, 467]], # Between the key numbers 13 and 14, the first number of the first list has been skipped and the second is smaller. so should repeat the key number.
    15: [[5, 44, 11, 5, 61, 504], [13, 22, 2, 4, 8], [26, 7, 50, 4, 13, 203]],
    16: [[5, 40, 35, 1, 20, 61], [13, 26, 26, 3, 27], [0, 9, 51, 2, 6, 646]], # this key_value pair should delete, because the first number of the first list is the same number second number of the list is smaller
    17: [[6, 40, 35, 1, 20, 61], [14, 26, 26, 3, 27], [2, 9, 51, 2, 6, 646]]
